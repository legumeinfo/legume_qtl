...
$pubs = $feature->mainlab_qtl->publications;
    ...
    <table id="tripal_feature-pub-table" class="tripal_feature-table tripal-table tripal-table-vert" style="border-bottom:solid 2px #999999">
      ...
      $class = "";
       ...
       foreach ($pubs AS $pub) {
         ...
         print "<td style=\"padding:5px 10px 5px 10px;\">". $pub->pyear . "</td><td><a href=\"/node/$pub->nid\">$pub->uniquename</a></td><td style=\"padding:5px 0px 5px 0px;\">" . $pub->title . "</td></tr>";
         $counter ++;
       } ?>
   </table>
</div> <?php 
