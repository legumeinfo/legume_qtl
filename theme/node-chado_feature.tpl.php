...
//
// To Customize the Feature Node Page:
...
<div id="tripal_feature_details" class="tripal_details">
   ...
   <?php
    ...
    if ($feature->type_id->name == 'QTL') {
      ...
      print theme('tripal_feature_base', $node);
      print theme('tripal_feature_references', $node);
      print theme('tripal_feature_properties', $node);
      print theme('tripal_feature_terms', $node);
